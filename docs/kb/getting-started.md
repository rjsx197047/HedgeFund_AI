...
By default the debate is a **stub** — agent messages reference real Yahoo Finance data but the reasoning is canned. To activate real LLM reasoning, configure an OpenAI API key in Settings. See [configuring-llm-providers.md](configuring-llm-providers.md).
