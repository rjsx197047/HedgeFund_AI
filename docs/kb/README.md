...
| [how-it-works.md](how-it-works.md) | Conceptual walkthrough of the multi-agent debate pipeline |
| [configuring-llm-providers.md](configuring-llm-providers.md) | Paste API keys for OpenAI, Anthropic, DeepSeek, OpenRouter; how keys are stored |
...
| [security-and-storage.md](security-and-storage.md) | Where keys and state live on disk; encryption model; machine migration |
...
2. [configuring-llm-providers.md](configuring-llm-providers.md) — paste your OpenAI key so debates run live
